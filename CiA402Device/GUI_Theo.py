...
class Window2(Cia402device.CiA402Device):
    def __init__(self, master):
        ...
        self.master.geometry('600x400+800+150')
        self.frame.pack(fill = BOTH, expand = 1)
        #Buttons
        #Quit
