...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_SocketCanPort')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_SocketCanPort')
    _SocketCanPort = swig_import_helper()
    ...
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_SocketCanPort', [dirname(__file__)])
        except ImportError:
            import _SocketCanPort
            return _SocketCanPort
        try:
            _mod = imp.load_module('_SocketCanPort', fp, pathname, description)
        finally:
            if fp is not None:
                fp.close()
        return _mod
...
class SocketCanPort(PortBase.PortBase):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, SocketCanPort, name, value)
    __swig_getmethods__ = {}
    for _s in [PortBase.PortBase]:
